...
## 🎨 Additional Note
The provided assets (briefcase.png, arrows.png) contained opaque white backgrounds rather than transparency. To maintain a clean UI without manual image editing, I used a CSS-based solution:

* **Implementation**: Applied mix-blend-mode: color-burn; to programmatically remove white backgrounds.
* **Trade-off**: This achieved the required transparency but altered the icon colors slightly. I prioritized the "transparent" look of the design over color accuracy, given the provided assets.
* **Recommendation**: In a production workflow, I would utilize SVGs to ensure background transparency and perfect match to design.
